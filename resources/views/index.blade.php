                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between">
                                    <div>
                                        ...
                                        <!-- Subtitle -->
                                        <h2 class="mb-0" id="income-section">${{ $income }}</h2>
                                        <!-- Comment -->
    ...
    <div class="row">
        <div class="col-xxl-5 d-flex">
            ...
            <div class="card border-0 flex-fill w-100">
                <div class="card-header border-0 card-header-space-between">
                    <!-- Title -->
                    <h2 class="card-header-title h4 text-uppercase">Projects</h2>
        ...
        <div class="col-xxl-7 d-flex">
            ...
            <div class="card border-0 flex-fill w-100">
                <div class="card-header border-0 card-header-space-between">
                    <!-- Title -->
                    <h2 class="card-header-title h4 text-uppercase">Sales</h2>
