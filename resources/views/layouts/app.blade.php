            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidenavCollapse">
                    ...
                    <ul class="navbar-nav mb-lg-7">
                        ...
                        {{-- <li class="nav-item dropdown">
                            <a class="nav-link active" href="#pagesCollapse" data-bs-toggle="collapse" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'users.index' ? 'active' : '' }}"
                                ...
                                <img class="nav-link-icon" src="{{ url('/assets/images/icons/users.svg') }}"
                                    alt="Users">
                                <span>Users</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'users.index' ? 'active' : '' }}"
                                href="{{ route('users.index') }}">
                                <img class="nav-link-icon" src="{{ url('/assets/images/icons/branches.svg') }}"
                                    alt="Users">
                                <span>Branches</span>
                            </a>
                        </li>
                                        ...
                                        <a href="{{ $notification->data['url'] ?? 'javascript:void(0);' }}"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-circle avatar-xs me-2">
                                                    <img src="{{ url('assets/images/icons/new_user_icon.svg') }}"
                                                        alt="New notification" class="avatar-img" width="30"
                                                        height="30">
                                                </div>
                                                ...
                                                <div class="d-flex flex-column flex-grow-1">
                                                    <div class="d-flex w-100 justify-content-between">
                                                        <h5 class="mb-1">
                                                            {{ $notification->data['action'] ?? 'Notification' }}</h5>
                                                        <small
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <p class="mb-1">
                                                            {{ $notification->data['details'] ?? 'You have a new notification.' }}
                                                        </p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you'd like to delete user "<span id="userName"></span>" ?</p>
                </div>
                <div class="modal-footer">
                    ...
                    <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                        @csrf
                        @method('delete')
                        <button type="button" class="btn btn-primary" id="deleteUserButton"
                            data-user-id=''>Delete</button>
                    </form>
                </div>
            </div>
        </div>
